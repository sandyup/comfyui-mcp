...
| `wan-longer-videos-v2v` | wan-longer-videos | video→video | 🟡 | **24gb tier needs 832×480** — at 1280×720 the input-video overhead pushes even the Q4 model fully to offload on a 4090 (crawls). Lowered to 832×480 + frame_load_cap 81; render-verify pending GPU. The -96gb variant keeps 1280×720 fp16 |
