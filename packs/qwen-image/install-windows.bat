...
rem Pack: Qwen-Image (20B T2I + WAN combo)
...
echo -------- models --------
call :grab "models\text_encoders\Qwen2.5-VL-7B-Instruct-UD-Q4_K_S.gguf" "https://huggingface.co/Aitrepreneur/FLX/resolve/main/Qwen2.5-VL-7B-Instruct-UD-Q4_K_S.gguf"
...
call :grab "models\unet\Qwen_Image_Distill-Q4_K_S.gguf" "https://huggingface.co/Aitrepreneur/FLX/resolve/main/Qwen_Image_Distill-Q4_K_S.gguf"
