...
call :grab "models\loras\Qwen-Image-Lightning-8steps-V1.1.safetensors" "https://huggingface.co/Aitrepreneur/FLX/resolve/main/Qwen-Image-Lightning-8steps-V1.1.safetensors"
