...
description: "comfyui-mcp is a full Claude Code plugin: 20 AI skills, 11 slash commands, 4 autonomous agents, and 4 hooks on top of the 89 MCP tools — expert ComfyUI knowledge that grows with every release."
icon: "puzzle-piece"
---
