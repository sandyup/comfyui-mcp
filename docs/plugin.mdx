...
description: "comfyui-mcp is a full Claude Code plugin: 16 AI skills, 11 slash commands, 4 autonomous agents, and 4 hooks on top of the 88 MCP tools — expert ComfyUI knowledge that grows with every release."
icon: "puzzle-piece"
---
