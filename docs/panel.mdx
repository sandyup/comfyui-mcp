---
title: "Sidebar Panel"
description: "ComfyUI Agent Panel — an autonomous AI agent in ComfyUI's sidebar that drives your canvas, now on EITHER Claude or ChatGPT (Codex / GPT-5) on your own subscription, no API key. Available on the Comfy Registry as comfyui-agent-panel."
icon: "comments"
---
