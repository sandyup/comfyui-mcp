...
running ComfyUI instance — local or remote — so you can generate images, execute and author
workflows, manage models and custom nodes, and control the server, all in natural language.
...
<CardGroup cols={2}>
  ...
  <Card title="Tool Reference" icon="wrench" href="/tools/image-generation">
    70+ tools, auto-documented from their live schemas.
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="Works remotely" icon="globe">
    Point at any ComfyUI over HTTP with `--comfyui-url` — no local install required.
  </Card>
</CardGroup>
